            ...
            <div className="lg:col-span-3 bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="border-b border-gray-200">
                <nav className="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                  ...
                  <button
                    onClick={() => router.push(`/organizer/ticket-setup?eventId=${eventId}`)}
                    ...
                    <div className="py-8 text-center">
                      <div className="mx-auto max-w-md">
                        ...
                        <div className="p-8 border-2 border-dashed border-gray-300 rounded-lg">
                          ...
                          <p className="text-sm text-gray-600 mb-4">You'll be able to set up seating after updating the basic event details</p>
                          <button
                            type="button"
