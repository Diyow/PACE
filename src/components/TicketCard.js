...
// import Link from 'next/link'; // Link is no longer needed
...
function TicketCard({ ticket }) {
  ...
  return (
    <div className="group block"> {/* The 'block' class might still be useful for layout, 'group' for styling if used elsewhere */}
      <div className="flex bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-300 ease-in-out group-hover:shadow-lg group-hover:border-sky-200 group-hover:scale-[1.01]">
        <div className="w-1/3 sm:w-48 md:w-56 bg-gradient-to-br from-sky-50 to-blue-100 flex items-center justify-center relative p-4">
